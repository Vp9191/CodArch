...
export default function Auth() {
    ...
    return (
        <div className="auth-page">
            <div className="auth-bg-blob auth-bg-top" />
            <div className="auth-bg-blob auth-bg-bottom" />
            ...
            <div className="auth-container animate-fade-in-up">
                    ...
                    <div className="auth-card-body">
                        ...
                        <div className="auth-header">
                            ...
                            <p className="auth-desc">
                                {isLogin ? 'Sign in to continue to CodArch' : 'Sign up to start analyzing your code'}
                            </p>
                        </div>
                ...
                <p className="auth-footer-text">
                    By continuing, you agree to CodArch's Terms of Service.
                </p>
            </div>
        </div>
    );
